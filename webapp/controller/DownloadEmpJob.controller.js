sap.ui.define([
	...
	return Controller.extend("gitTest.GitTest.controller.DownloadEmpCompensation", {
		...
		onDownload: function () {
			...
			window.open("https://sapserverz3pthbmpqp.ap1.hana.ondemand.com/retire-demo/download?loginUser=" + loginUser + "&userArray=" + userArrayString + "&entity=EmpJob", "_self");
		},
